...
const styles = StyleSheet.create({
  ...
  colAnalito: { width: '30%', fontWeight: 'bold' },
  colResultado: { width: '25%', flexDirection: 'row', justifyContent: 'center', alignItems: 'center', fontWeight: 'bold', textAlign: 'center' },
  flagSpace: { width: 12, alignItems: 'center', justifyContent: 'center' }, 
